...
/**
* Class Vector is the basic class representing a … of Euclidean geometry in Cartesian
...
public class Vector extends Point {
	...
	public Vector(Double3 d) { this(d.d1, d.d2, d.d3); }
	...
	public Vector scale(double num) { return new Vector(this.point.scale(num)); }
	...
	public double lengthSquared() {
	    ...
	    return this.point.d1 * this.point.d1 + this.point.d2 * this.point.d2 + this.point.d3 * this.point.d3;	
	}
	...
	public Vector normalize() { return new Vector (this.point.reduce(this.length())); }
