...
public class IntegrationTests {
    ...
    public void cameraTriangleIntersections() {
        ...
        intersections=CountIntersections(camera, new Triangle(new Point(0,1,-2), new Point(1,-1 -2), new Point(-1, -1, -2)));
        assertEquals(1, intersections, "number of trianlge intersections is incorrect");
        // TC02: a bigger triangle with 2 intersections
        intersections=CountIntersections(camera, new Triangle(new Point(0,20,-2), new Point(1,-1 -2), new Point(-1, -1, -2)));
