...
public class LightsTests {
	...
	private final Geometry triangle3 = new Triangle(vertices[0], vertices[1], vertices[2]).setMaterial(material2);
	private final Geometry triangle4 = new Triangle(vertices[0], vertices[1], vertices[3]).setMaterial(material2);
	...
	public void trianglesPolyLights() {
		...
		scene2.lights.add(new SpotLight(new Color(BLUE), trianglesLightPosition, new Vector(-2, 10, -2)).setKl(0.001)
				.setKq(0.0001));
